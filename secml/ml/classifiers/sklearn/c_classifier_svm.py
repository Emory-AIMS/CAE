...
class CClassifierSVM(CClassifierLinear, CClassifierGradientSVMMixin):
    ...
    def _fit(self, dataset):
        ...
        # Yhat_svc_linear_train = classifier.predict(self._k.get_data())
        # acc_train = np.mean(Yhat_svc_linear_train == dataset.Y.tondarray())
    ...
    def _decision_function(self, x, y=None):
        ...
        a = CArray(k).todense().ravel()
        score = a + self.b   ##########has problem
